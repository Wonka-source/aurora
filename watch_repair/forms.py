...
class WatchRepairForm(forms.ModelForm):
    class Meta:
        model = WatchRepair
        fields = ['full_name', 'email', 'phone_number', 'quartz', 'mechanical', 'chronograph', 'description']
        widgets = {
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['description'].widget.attrs.update({'placeholder': 'Brand/Case Reference/Fault'})
