...
#### Epic
This site will provide the user with a selection of luxery watches accessories, and watch tools to purchase. The website will also have a form to fill out to get an estmite for a watch repair or service.  
...
As a **user** I can **contact customer service to ask questions about my order or a specific watch** so that **I can receive assistance.**
...
Home page - a landing page with a heading "The Watch Shop" and a call to action button "Shop Now":
...
Drop down menu for mobile views:
...
Cart - user can adjust the quantity and update the cart and remove items form the cart accordingly:
...
Stripe payments - amount to be charged displayed clearly:
...
User profile - Here is were the user can store their default delivery information and view their order history:

![profile page](https://res.cloudinary.com/dmvf3llw4/image/upload/v1683160982/profilepage_qcauat.jpg)

Order history - on the user profile page:
...
Repairs page - here the user can submit an enquiry to get an estimate on a repair or service:
...
![enter image description here](https://res.cloudinary.com/dmvf3llw4/image/upload/v1683162267/edit_product_wbmo26.jpg)
...
Privacy policy - link located on the bottom left of the footer:
